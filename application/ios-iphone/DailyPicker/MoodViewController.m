...
- (void)viewDidLoad
{
    ...
    stars = [NSArray arrayWithObjects:[UIImage imageNamed:@"5Stars.png"], [UIImage imageNamed:@"4Stars.png"], [UIImage imageNamed:@"3Stars.png"], [UIImage imageNamed:@"2Stars.png"], [UIImage imageNamed:@"1Star.png"], nil];
...
//    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    ...
    UIImageView *tmpMood = (UIImageView *) [cell viewWithTag:100];
    tmpMood.image = [stars objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSLog(@"reports that the %d mood was selected", self.selectedIndex);
	[self.delegate moodWasSelected:self];
